...
def convert_med_to_xdmf(
    med_filename, filename_extension="2D"
):
    ...
    domains_file = meshio.write_points_cells(
        "mesh_domains_{}.xdmf".format(filename_extension),
        mesh.points,
        [mesh.cells[1]],
    ...
    boundaries_file = meshio.write_points_cells(
        "mesh_boundaries_{}.xdmf".format(filename_extension),
        mesh.points,
        [mesh.cells[0]],
...
if __name__ == "__main__":
    convert_med_to_xdmf(
        med_filename="WCLL_2D_floriane.med",
        filename_extension="floriane",
    )
