...
data_both_no_traps = np.genfromtxt(
    folder + '/both_no_traps/derived_quantities.csv',
    delimiter=',', names=True)    
...
data_breeder_no_traps = np.genfromtxt(
    folder + '/breeder_no_traps/derived_quantities.csv',
    delimiter=',', names=True)
...
data_plasma_no_traps = np.genfromtxt(
    folder + '/plasma_no_traps/derived_quantities.csv',
    delimiter=',', names=True)
...
fw_cooling_channel_breeder_no_traps = data_breeder_no_traps['Flux_surface_39_solute']*-1
...
plt.plot(
    t, fw_cooling_channel_both_traps, label='Both', color='black')
plt.plot(
    t, fw_cooling_channel_both_no_traps, color='black',
    linestyle='dashed')
plt.plot(
    t, fw_cooling_channel_breeder_traps, label='Breeder', color=green_lipb)
plt.plot(
    t, fw_cooling_channel_breeder_no_traps, color=green_lipb,
    linestyle='dashed')
plt.plot(
    t, fw_cooling_channel_plasma_traps, label='Plasma', color=red_W)
plt.plot(
    t, fw_cooling_channel_plasma_no_traps, color=red_W,
    linestyle='dashed')
