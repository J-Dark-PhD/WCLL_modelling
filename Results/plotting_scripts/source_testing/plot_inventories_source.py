...
structure_both_traps = (
    data_both_traps["Total_retention_volume_8"]
    + data_both_traps["Total_retention_volume_9"]
)
first_wall_both_traps = data_both_traps["Total_retention_volume_7"]
bz_pipes_both_traps = sum(
    [
        data_both_traps["Total_retention_volume_{}".format(vol)]
...
structure_breeder_traps = (
    data_breeder_traps["Total_retention_volume_8"]
...
bz_pipes_breeder_traps = sum(
    [
        data_breeder_traps["Total_retention_volume_{}".format(vol)]
        for vol in volumes_bz_pipes
    ]
)
...
structure_plasma_traps = (
    data_plasma_traps["Total_retention_volume_8"]
...
bz_pipes_plasma_traps = sum(
    [
        data_plasma_traps["Total_retention_volume_{}".format(vol)]
        for vol in volumes_bz_pipes
    ]
)
...
plt.plot(t_both_traps, lipb_both_traps, color="black")
plt.plot(t_breeder_traps, lipb_breeder_traps, color=green_lipb)
plt.plot(t_plasma_traps, lipb_plasma_traps, color=red_W)
plt.annotate(
    "LiPb",
    (t_both_traps[-1], lipb_both_traps[-1]),
    xytext=(t_both_traps[-1] * 1.1, lipb_both_traps[-1]),
    color="black",
)
...
plt.sca(ax2)
plt.plot(t_both_traps, structure_both_traps, color="black")
plt.plot(t_breeder_traps, structure_breeder_traps, color=green_lipb)
plt.plot(t_plasma_traps, structure_plasma_traps, color=red_W)
plt.annotate(
    "Structure",
    (t_both_traps[-1], structure_both_traps[-1]),
    xytext=(t_both_traps[-1] * 1.1, structure_both_traps[-1]),
    color="black",
)
...
plt.sca(ax3)
plt.plot(t_both_traps, bz_pipes_both_traps, color="black")
plt.plot(t_breeder_traps, bz_pipes_breeder_traps, color=green_lipb)
plt.plot(t_plasma_traps, bz_pipes_plasma_traps, color=red_W)
plt.annotate(
    "BZ pipes",
    (t_both_traps[-1], bz_pipes_both_traps[-1]),
    xytext=(t_both_traps[-1] * 1.1, bz_pipes_both_traps[-1]),
    color="black",
)
...
plt.sca(ax4)
plt.plot(t_both_traps, first_wall_both_traps, color="black")
plt.plot(t_breeder_traps, first_wall_breeder_traps, color=green_lipb)
plt.plot(t_plasma_traps, first_wall_plasma_traps, color=red_W)
plt.annotate(
    "First wall",
    (t_both_traps[-1], first_wall_both_traps[-1]),
    xytext=(t_both_traps[-1] * 1.1, first_wall_both_traps[-1]),
    color="black",
)
