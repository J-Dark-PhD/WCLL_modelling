...
data_liu = np.genfromtxt(
    folder + '/liu_standard/derived_quantities.csv',
    delimiter=',', names=True)

data_braun = np.genfromtxt(
    folder + '/braun/derived_quantities.csv',
    delimiter=',', names=True)    

data_esteban = np.genfromtxt(
    folder + '/esteban/derived_quantities.csv',
    delimiter=',', names=True)

data_inst = np.genfromtxt(
    folder + '/instantaneous/derived_quantities.csv',
    delimiter=',', names=True)
...
pipes_flux_liu = pipe_1_flux_liu + pipe_2_flux_liu + pipe_3_flux_liu + \
    pipe_4_flux_liu + pipe_5_flux_liu + pipe_6_flux_liu + pipe_7_flux_liu + \
    pipe_8_flux_liu + pipe_9_flux_liu + pipe_10_flux_liu
...
pipes_flux_braun = pipe_1_flux_braun + pipe_2_flux_braun + pipe_3_flux_braun + \
    pipe_4_flux_braun + pipe_5_flux_braun + pipe_6_flux_braun + pipe_7_flux_braun + \
    pipe_8_flux_braun + pipe_9_flux_braun + pipe_10_flux_braun
...
pipes_flux_esteban = pipe_1_flux_esteban + pipe_2_flux_esteban + pipe_3_flux_esteban + \
    pipe_4_flux_esteban + pipe_5_flux_esteban + pipe_6_flux_esteban + pipe_7_flux_esteban + \
    pipe_8_flux_esteban + pipe_9_flux_esteban + pipe_10_flux_esteban
...
pipes_flux_inst = pipe_1_flux_inst + pipe_2_flux_inst + pipe_3_flux_inst + \
    pipe_4_flux_inst + pipe_5_flux_inst + pipe_6_flux_inst + pipe_7_flux_inst + \
    pipe_8_flux_inst + pipe_9_flux_inst + pipe_10_flux_inst

plt.figure()

plt.plot(
    t, fw_cooling_channel_liu, label='Liu', color='black')
plt.plot(
    t, fw_cooling_channel_braun, label='Braun')
plt.plot(
    t, fw_cooling_channel_esteban, label='Esteban')
plt.plot(
    t, fw_cooling_channel_inst, label='Instantaneous')
...
plt.figure()
plt.plot(
    t, pipes_flux_liu, label='Liu', color='black')
plt.plot(
    t, pipes_flux_braun, label='Braun')
plt.plot(
    t, pipes_flux_esteban, label='Esteban')
plt.plot(
    t, pipes_flux_inst, label='Instantaneous')
