...
plt.plot(
    t_no_traps, front_no_traps,
    color=colour, linestyle="dashed", alpha=0.5)
plt.annotate(
    "Front BZ pipes", (x_annotation, front[-1]), color=colour)
...
plt.plot(
    t_no_traps, middle_flux_no_traps,
    color=colour, linestyle="dashed", alpha=0.5)
plt.annotate(
    "Middle BZ pipes", (x_annotation, middle_flux[-1]*0.85), color=colour)

colour = 'steelblue'
rear_flux = pipe_3 + pipe_4 + pipe_9 + pipe_10
rear_flux_no_traps = pipe_3_no_traps + pipe_4_no_traps + pipe_9_no_traps + \
     pipe_10_no_traps
plt.plot(t, rear_flux, color=colour)
plt.plot(
    t_no_traps, rear_flux_no_traps,
    color=colour, linestyle="dashed", alpha=0.5)
plt.annotate(
