...
structure_without_buoyancy = data_without_buoyancy['Total_retention_volume_8'] + \
    data_without_buoyancy['Total_retention_volume_9']
first_wall_without_buoyancy = data_without_buoyancy['Total_retention_volume_7']
bz_pipes_without_buoyancy = \
    sum([data_without_buoyancy['Total_retention_volume_{}'.format(vol)]
...
structure_with_buoyancy = data_with_buoyancy['Total_retention_volume_8'] + \
...
bz_pipes_with_buoyancy = \
    sum([data_with_buoyancy['Total_retention_volume_{}'.format(vol)]
        for vol in volumes_bz_pipes])
...
plt.plot(
    t_without_buoyancy, lipb_without_buoyancy, color='black')
plt.plot(
    t_with_buoyancy, lipb_with_buoyancy, color='red')
# plt.annotate(
...
plt.sca(ax2)
plt.plot(
    t_without_buoyancy, structure_without_buoyancy, color='black')
plt.plot(
    t_with_buoyancy, structure_with_buoyancy, color='red')
# plt.annotate(
...
plt.sca(ax3)
plt.plot(
    t_without_buoyancy, bz_pipes_without_buoyancy, color='black')
plt.plot(
    t_with_buoyancy, bz_pipes_with_buoyancy, color='red')
# plt.annotate(
...
plt.sca(ax4)
plt.plot(
    t_without_buoyancy, first_wall_without_buoyancy, color='black')
plt.plot(
    t_with_buoyancy, first_wall_with_buoyancy, color='red')
# plt.annotate(
