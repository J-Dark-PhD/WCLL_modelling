...
plt.plot(
    t_no_buoyancy, eurofer_no_buoyancy, color=colour, linestyle="dashed", alpha=0.5
)
...
plt.plot(t_no_buoyancy, front_no_buoyancy, color=colour, linestyle="dashed", alpha=0.5)
plt.annotate("Front BZ pipes", (x_annotation, front[-1] * 1.2), color=colour)
...
plt.plot(
    t_no_buoyancy, middle_flux_no_buoyancy, color=colour, linestyle="dashed", alpha=0.5
)
plt.annotate("Middle BZ pipes", (x_annotation, middle_flux[-1] * 0.8), color=colour)

colour = "steelblue"
rear_flux = pipe_3 + pipe_4 + pipe_9 + pipe_10
rear_flux_no_buoyancy = (
    pipe_3_no_buoyancy + pipe_4_no_buoyancy + pipe_9_no_buoyancy + pipe_10_no_buoyancy
)
plt.plot(t, rear_flux, color=colour)
plt.plot(
    t_no_buoyancy, rear_flux_no_buoyancy, color=colour, linestyle="dashed", alpha=0.5
)
